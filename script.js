...
console.log("Const Access: ", anotherExample);
...
// console.log("forEach:");
// newFruits =  fruits.forEach((fruit) => {
//   console.log(fruit);
// })
...
let [newUser, setUser ] = user; // map: newUser => {firstname, lastname} ; setUser => (user) => {console.log("I set the user: ", user)}
console.log(newUser);
